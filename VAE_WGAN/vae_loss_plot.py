...
if __name__ == '__main__':
    vae_loss_data = np.load('../naive_VAE/processed_by_zwt/loss/loss1.npy', allow_pickle=True)
    gan_loss_data = np.load('./processed_by_zwt/loss/loss0.npy', allow_pickle=True)
    print(vae_loss_data.shape)
    vae_loss_plot(vae_loss_data)
    vae_loss_plot_with_variance(vae_loss_data)
    gan_loss_plot(gan_loss_data)
